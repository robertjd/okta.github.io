...
access_token      | Used to access the [`/oauth2/v1/userinfo`](/docs/api/resources/oidc.html#get-user-information) endpoint. This is returned if the *response_type* includes `token`. Unlike the ID Token JWT, the *access_token* structure is specific to Okta, and is subject to change.| String  |
...
scope             | Scopes specified in the *access_token*. Returned only returned if the response includes an *access_token*. | String |
state             | The unmodified `state` value from the request. | String |
error             | Error-code string providing information if anything went wrong. | String |
...
~~~json
{
  "access_token": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..hb3oS92Nb7QmLz2R99SfB_qqTP9GsMCtc2umA2sJwe4",
  "token_type": "Bearer",
  "expires_in": 3600,
  "scope": "openid offline_access",
  "refresh_token": "IJFLydLpLZ7-9spMSePkqgBSTnjBluJIJi6HESG84cE",
  "id_token": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.._uLqItzLzKb6m6G2-Jqs6OmrG_iWMg0P6UKQqzVggPc"
}
~~~
